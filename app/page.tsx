    ...
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        <header className="flex items-center justify-between border-b border-border py-6">
          ...
          <div className="flex items-center gap-4"><span className="hidden font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground sm:block">Cosmos / claridad / conexión</span><a href="https://blobs.vusercontent.net/blob/informe_astral_demo-ufH65io5rptxd6TQan1f9qOW4gsgD0.pdf" target="_blank" rel="noopener noreferrer" className="font-heading text-xs font-semibold text-primary hover:underline sm:text-sm">Ver una demo</a><a href="https://astrocreditos.vercel.app/demo" className="font-heading text-xs font-semibold text-primary hover:underline sm:text-sm">Crea tu informe</a><a href="https://api.whatsapp.com/send/?phone=34659059392&text=hola,%20necesito%20aclarar%20alguna%20duda" target="_blank" rel="noopener noreferrer" className="font-heading text-sm font-semibold text-primary hover:underline">Contacto</a></div>
        </header>
