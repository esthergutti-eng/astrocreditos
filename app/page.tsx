      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        ...
        <section id="top" className="relative flex min-h-[500px] flex-col justify-center py-20 lg:min-h-[600px] lg:py-28">
          ...
          <div className="relative max-w-3xl">
            ...
            <Link href="/auth/signup" className="mt-10 inline-flex items-center gap-3 rounded-md bg-primary px-6 py-3.5 font-heading text-sm font-bold text-primary-foreground shadow-glow transition-transform duration-200 ease-out hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background">Crear cuenta gratis <ArrowUpRight className="size-4" aria-hidden="true" /></Link>
          </div>
